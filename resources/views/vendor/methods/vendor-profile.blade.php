                            ...
                            <form action="{{ route('vendor.profile.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <select name="vendor_join" class="form-select mb-1" aria-label="Default select example">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea name="vendor_short_info" class="form-control" id="inputAddress" placeholder="Address..." rows="3">{{$vendorData->vendor_short_info}}</textarea>
                                        </div>
                                    </div> <!-- address -->
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
