...
<main class="main">
    ...
    @include('frontend.home.home-features-category')

    @include('frontend.home.home-banner')

    @include('frontend.home.home-new-products')

    @include('frontend.home.home-features-products')
    ...
    @include('frontend.home.home-vendor-list')
